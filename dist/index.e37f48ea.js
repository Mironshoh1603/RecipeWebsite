...
},{"regenerator-runtime":"dXNgZ","./model.js":"Y4A21","./views/recipeview.js":"8Jlc1"}],"dXNgZ":[function(require,module,exports) {
/**
...
const loadRecipe = async function(id) {
    let data1 = await fetch(`https://forkify-api.herokuapp.com/api/v2/recipes/${id}`);
...
class RecipeClass {
    ...
    <div class="recipe__description">
     ...
     #generatorHtml(data1) {
        recipeContainer.innerHTML = '';
        let html = `<figure class="recipe__fig">
  <img src="${data1.image}" alt="Tomato" class="recipe__img" />
  <h1 class="recipe__title">
...
<div class="recipe__ingredients">
  <h2 class="heading--2">Recipe ingredients</h2>
  <ul class="recipe__ingredient-list">
  ${this.#renderIng(data1.indegridents).join('')}  
  </ul>
</div>
<div class="recipe__directions">
  <h2 class="heading--2">How to cook it</h2>
